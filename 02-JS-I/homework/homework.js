...
// Todo tu código irá dentrno de las llaves de la función.
...
function esPositivo(numero) {if (numero === 0) {return "false";} else if (num > 0) {return "es positivo";} else {return "es negativo";}}

function agregarSimboloExclamacion(str) {return str + '!';}

function combinarNombres(nombre, apellido) {var combinado = nombre + ' ' + apellido;
return combinado;}
